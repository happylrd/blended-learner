...
<script type="text/javascript">
    ...
    //条件查询
    function initData(studentId, position) {
        if (position === "3") {
...
<body onload="initData('${session.currentUser.username}','${session.currentUser.position}')">
...
<div id="dataList" style="display:none;">
    ...
    <div id="dlg" class="easyui-dialog" style="padding:10px 30px"
        ...
        <s:form name="fm" id="fm" action="" method="post">
            ...
            <table border="0">
                <tr>
                    <td>学号：</td>
                    <td><input name="course.studentId" class="easyui-textbox" readonly="readonly"
                               style="height: 30px; width: 200px; " value="${session.currentUser.username}"/></td>
                </tr>
                <tr>
                    <td>班级：</td>
                    <td><input name="course.classId" class="easyui-textbox" required="true"
                               style="height: 30px; width: 200px; "/></td>
                </tr>
                <tr>
                    <td>姓名：</td>
                    <td><input name="course.name" class="easyui-textbox" required="true"
                               style="height: 30px; width: 200px;  "/></td>
                </tr>
                <tr>
                    <td>电子邮箱：</td>
                    <td><input name="course.email" class="easyui-validatebox"
                               data-options="required:true,validType:'email'" style="height: 30px; width: 200px; "/>
                    </td>
                </tr>
                <tr>
                    <td>手机号：</td>
                ...
                <tr>
                    <td>学年：</td>
                    <td><input name="course.syear" class="easyui-textbox"
                               data-options="required:true,validType:'number'" style="height: 30px; width: 200px;"/>(如:2015)
                    </td>
                </tr>
            </table>
    ...
    <div id="dlg-buttons">
        <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveSelectCourse()"
